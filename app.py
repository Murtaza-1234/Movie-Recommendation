...
all_movie_titles = sorted(movies['title'].unique().tolist())
...
st.caption("Can't find your movie in the list? Describe it below instead.")
if st.button("🎭 My movie isn't listed"):
    st.session_state["show_manual_form"] = True
